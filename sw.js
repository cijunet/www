const APP='ciju-app-47974300';        // 缓存版本：随数据指纹自动变化，旧缓存自动失效（无需手改）
const SHELL=['./','./index.html','./assets/style.css','./assets/msgpack.min.js','./assets/manifest.webmanifest','./assets/icon.svg','./404.html','./scenes/','./moods/','./places/','./authors/','./search/','./data/today.json.gz','./data/meta.json.gz','./data/geo.json.gz','./assets/js/bootstrap.js','./assets/js/card.js','./assets/js/clipboard.js','./assets/js/codec.js','./assets/js/datacache.js','./assets/js/db.js','./assets/js/detail.js','./assets/js/hashsearch.js','./assets/js/meta.js','./assets/js/nav.js','./assets/js/nearme.js','./assets/js/perf.js','./assets/js/preload.js','./assets/js/random.js','./assets/js/records.js','./assets/js/related.js','./assets/js/router.js','./assets/js/search-delegate.js','./assets/js/search-ui.js','./assets/js/search-worker.js','./assets/js/site.js','./assets/js/suggest.js','./assets/js/theme.js','./assets/js/today.js','./assets/js/tts.js','./assets/js/util.js','./assets/js/worker-client.js'];
